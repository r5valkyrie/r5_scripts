...
{
	asset titan_model = $"mdl/titans/buddy/titan_buddy.rmdl"
	...
	ModelFX_BeginData( "titanDamage", titan_model, "all", true )
		...
		ModelFX_AddTagBreakGib( 1, "exp_L_shoulder", $"mdl/gibs/titan_gibs/at_gib9_l_bicep1.rmdl", GIBTYPE_DEATH, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_elbow", $"mdl/gibs/titan_gibs/at_gib9_l_bicep1.rmdl", GIBTYPE_DEATH, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_front", $"mdl/gibs/titan_gibs/at_gib8_l_thigh1.rmdl", GIBTYPE_NORMAL, 400, 500 )

		ModelFX_AddTagDamageFX( 1, "dam_L_thigh_side", $"xo_spark_med", 1.5, 6.0, "titan_damage_spark" )
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_side", $"mdl/gibs/titan_gibs/at_gib8_l_thigh2.rmdl", GIBTYPE_NORMAL, 400, 500 )

		ModelFX_AddTagDamageFX( 1, "dam_L_thigh_back", $"xo_spark_med", 1.5, 6.0, "titan_damage_spark" )
		ModelFX_AddTagBreakGib( 1, "dam_L_thigh_back", $"mdl/gibs/titan_gibs/at_gib1.rmdl", GIBTYPE_NORMAL, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_thigh", $"mdl/gibs/titan_gibs/at_gib8_l_thigh1.rmdl", GIBTYPE_NORMAL, 400, 500 )
		...
		ModelFX_AddTagBreakGib( 1, "exp_R_knee", $"mdl/gibs/titan_gibs/at_gib7_r_shin.rmdl", GIBTYPE_DEATH, 400, 500 )

		//Death Explosion FX
//		ModelFX_AddTagBreakFX( null, "exp_torso_main", $"xo_exp_death", "titan_death_explode" )

		ModelFX_AddTagBreakGib( 2, "exp_torso_front", $"mdl/gibs/titan_gibs/at_gib_hatch_d.rmdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_L_shoulder", $"mdl/gibs/titan_gibs/at_gib_l_arm1_d.rmdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_L_elbow", $"mdl/gibs/titan_gibs/at_gib_l_arm2_d.rmdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_R_shoulder", $"mdl/gibs/titan_gibs/at_gib_r_arm1_d.rmdl", GIBTYPE_DEATH, 600, 800 )
		ModelFX_AddTagBreakGib( 2, "exp_R_elbow", $"mdl/gibs/titan_gibs/at_gib_r_arm2_d.rmdl", GIBTYPE_DEATH, 600, 800 )
