...
const asset AMPED_SHOT_PROJECTILE = $"mdl/weapons/bullets/temp_triple_threat_projectile_large.rmdl"
...
int function FireMissileStream( entity weapon, WeaponPrimaryAttackParams attackParams, bool predicted )
{
	...
	else
	{
		...
		MissileBoltParams.dir = attackParams.dir
		MissileBoltParams.speed = missileSpeed
		MissileBoltParams.scriptTouchDamageType = impactFlags
		MissileBoltParams.scriptExplosionDamageType = damageTypes.explosive | DF_KNOCK_BACK
		MissileBoltParams.clientPredicted = predicted
		entity missile = weapon.FireWeaponMissile( MissileBoltParams )
