...
const table<string, asset> STORE_SECTION_BG_MAP =
{
	...
	[ "#DOUBLE_TAKE_COLLECTION_EVENT" ] 		= $"ui_image/rui/menu/store/backgrounds/store_background_double_take.rpak",
	[ "#VOID_RECKONING_EVENT" ] 				= $"ui_image/rui/menu/store/backgrounds/store_background_me_void_reckoning.rpak",
	[ "#VOID_RECKONING_STORE" ] 				= $"ui_image/rui/menu/store/backgrounds/store_background_void_reckoning.rpak",
}
