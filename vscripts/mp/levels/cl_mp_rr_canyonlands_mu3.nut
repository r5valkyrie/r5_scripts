...
void function MinimapLabelsCanyonlandsMU3()
{
	...
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_11_A" ) ), 0.56, 0.91, 0.6 ) //Caustic Treatment
	...
	//UNIQUE
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_13_ARENA" ) ), 0.26, 0.35, 0.6 ) //The Pit
	...
	// MU2
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_19_A" ) ), 0.92, 0.27, 0.6 ) //The Rig
	...
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_07_C" ) ), 0.76, 0.84, 0.6 ) //"Map Room"
	...
	// MU3
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_19_E" ) ), 0.4, 0.10, 0.6 ) //"Crash Site"
	SURVIVAL_AddMinimapLevelLabel( GetZoneMiniMapNameForZoneId( MapZones_GetZoneIdForTriggerName( "Z_12_A" ) ), 0.25, 0.24, 0.6 )//"Spotted Lake"
}
