...
{
	if ( !WeaponSkin_DoesReactToKills( flavor ) )
		return -1

	int levelCount = WeaponSkin_GetReactToKillsLevelCount( flavor )
	int resultLevel = -1

	for ( int i = 0; i < levelCount; i++ )
	{
		WeaponReactiveKillsData data = WeaponSkin_GetReactToKillsDataForLevel( flavor, i )
