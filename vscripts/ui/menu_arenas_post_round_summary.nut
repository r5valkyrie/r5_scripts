...
const int ARENAS_UI_WIN_BY_2_MIN_SCORE = 3
const int ARENAS_UI_WIN_BY_2_MAX_TIES  = 2
...
{
	int minWinScore = ARENAS_UI_WIN_BY_2_MIN_SCORE
	bool isSuddenDeath = numTies == ARENAS_UI_WIN_BY_2_MAX_TIES
