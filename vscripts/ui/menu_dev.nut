...
void function SetupFriendlyNPC()
{
	...
	SetupDevCommand( "Friendly NPC: Super Spectre", "script DEV_SpawnSupSpectreAtCrosshair(gp()[0].GetTeam())" )
	SetupDevCommand( "Friendly NPC: Titan (BT)", "script DEV_SpawnTitanAtCrosshair(gp()[0].GetTeam())" )
	...
	SetupDevCommand( "Friendly NPC: Infected Pilot", "script DEV_SpawnInfectedSoldierAtCrosshair(gp()[0].GetTeam())" )
	SetupDevCommand( "Friendly NPC: Explosive Tick", "script DEV_SpawnExplosiveTickAtCrosshair(gp()[0].GetTeam())" )
	#endif
}
...
void function SetupEnemyNPC()
{
	...
	SetupDevCommand( "Enemy NPC: Super Spectre", "script DEV_SpawnSupSpectreAtCrosshair()" )
	SetupDevCommand( "Enemy NPC: Titan (BT)", "script DEV_SpawnTitanAtCrosshair()" )
